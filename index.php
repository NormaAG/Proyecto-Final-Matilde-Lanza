...
<body>
	<header>
		...
		<nav>
			<ul>
				<li><a href="logo.php"><span style="font-family:Federant,Monaco,monospace;font-size:17px;font-weight: bold;color:white;">UEmatilde</span><span style="font-family:Federant,Monaco,monospace;font-size:16px;font-weight: bold;color:rgb(94, 192, 124);">.com.bo</span></a></li>
						...
						<div id="derecha"><!-- derecha--->
							<table style="background-color:white;"><TR> 
									...
									<td style="vertical-align:middle;width:100%">
										<table >
											<tr><td style="white-space:nowrap;"><span style="font-family:Federant,Monaco,monospace;font-size:20px;font-weight: bold;color:#215F88;">UEmatilde</span><span style="font-family:Federant,Monaco,monospace;font-size:18px;font-weight: bold;color:#A11A1A;">.com.bo</span>&nbsp;&nbsp;</td></tr>
	...
	<script src="menu.js"></script> 
						...
						<?php include "include/cuerpo.php";?>	
