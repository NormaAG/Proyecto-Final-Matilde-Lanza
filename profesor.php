...
<div class="container"> <br><br><br>
 <center><section id="container" style="background:white; width:100%; height:100%; border-radius:0%; border: 0px solid #ccc;">
         <form action="" method="post">
            <h3 class="icon-at-and-t" style="font-size: 15pt;letter-spacing:1px; background: #2980b9;color: #FFF;text-align: center;padding: 10px;"> PROFESORES</h3>
                <h4 style="font-size: 11pt; letter-spacing: 1px;  background: #C1C0BF; padding: 10px;">Bienvenidos al Servicio a Profesores de la Unidad Educativa Matilde Lanza</h4>
           
            <img src="img/profesor.png" alt="login" title="INICIO DE SESION PARA PROFESORES ">
