...
INSERT INTO alumno VALUES("1","72737345","MARIA","LOPEZ SUAREZ","VILOMA KM 19 1/2","2020-01-17","fanny@gmail.com","77254324","img_440679b45ffe34241816284b0dd65853.jpg","1","1","1");
...
CREATE TABLE `notas` (
  ...
  CONSTRAINT `notas_ibfk_6` FOREIGN KEY (`bimestre`) REFERENCES `bimestre` (`bimestre`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `notas_ibfk_7` FOREIGN KEY (`idalumno`) REFERENCES `alumno` (`idalumno`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4;

INSERT INTO notas VALUES("21","9","6","Bimestre1 ","100","0","0","0");
