...
function Header(){// Cabecera de página
    ...
    $this->Cell(70,10,'Lista de Profesores U. E. Matilde Lanza',0,0,'C');// tamaño ancho cuadro,alto cuadro, Título,borde
    $this->Ln(25);// Salto de línea

    $this->SetTextColor(10, 0, 0 );
    $this->SetFont('times','B',10);
    $this->cell(15,10,'CI',0,0,'C',0);
    $this->cell(22,10,'Nombre',0,0,'C',0);
    $this->cell(32,10,'Apellidos',0,0,'C',0);
    $this->cell(30,10,'Direccion',0,0,'C',0);
    $this->cell(15,10,'FechaNac',0,0,'C',0);
    $this->cell(28,10,'Correo',0,0,'C',0);
    $this->cell(13,10,'Telefono',0,0,'C',0);
    $this->cell(35,10,'Especialidad',0,1,'C',0);
}
...
while($row = $resultado->fetch_assoc()){
    ...
    $pdf->cell(15,10,$row['fecha_nac'],1,0,'C',0);
    $pdf->cell(28,10,$row['correo'],1,0,'C',0);
    $pdf->cell(13,10,$row['telefono'],1,0,'C',0);
    $pdf->cell(35,10,$row['especialidad'],1,1,'C',0);
}
